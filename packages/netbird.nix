...
with pkgs.lib;
let
  version = if broken then {
    # this is the commit which breaks netbird Network Routes
    # https://github.com/netbirdio/netbird/commit/3cdb10cde765621086d15e97da150fee884356f6
    rev = "3cdb10cde765621086d15e97da150fee884356f6";
    sha256 = "sha256-f5FRiWyjuvJ5Y2u85qLmDdQf/UltQ3Ikn7zFmPoH5n4=";
    vendorHash = "sha256-JMynPCH5Zvzz8nYI7DPu9TzU+rWJemPwyDdlPkFiqds=";
  } else {
    # the parent of that commit works fine
    rev = "af95aabb0375f51872a4ff69dd12f412d716955e";
    sha256 = "sha256-hxefD1xFhzcJ49HeBDwN+C/Ej2EVFpg3NTrWYItlmuE=";
    vendorHash = "sha256-JMynPCH5Zvzz8nYI7DPu9TzU+rWJemPwyDdlPkFiqds";
  };
