# https://raw.githubusercontent.com/NixOS/nixos-hardware/0ed819e708af17bfc4bbc63ee080ef308a24aa42/raspberry-pi/3/default.nix
{ lib
, pkgs
, ...
}:

{
  ...
  # - tty0: hdmi
  boot.kernelParams = [
    # dont occupy the precious raspi UARTs with consoles
