#
# https://github.com/jhillyerd/homelab/blob/c764e632ffc39ee97b07485928ad2cee25073b78/nixos/roles/template.nix
#
{ config, pkgs, lib, ... }:
with lib;
let
      ...
      mkScript = name: entry:
        ...
        in
        {
          ...
          value = stringAfter [
            "etc"
            "agenix"
            # "agenixRoot" # error: attribute 'agenixRoot' missing ?
          ] "${activationScript}";
        };
    in
    mkIf (cfg.files != { }) {
